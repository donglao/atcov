...
from atconv_multi_head import AttentionConv2D
...
def conv_attn3x3(in_planes, out_planes, stride=1):
    """
    3x3 attention convolution
    """
    return AttentionConv2D(in_planes, out_planes, kernel_size=3,
                     stride=stride)
...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None):
        ...
        #self.conv1 = conv_attn3x3(inplanes, planes, stride)
        self.bn1 = nn.BatchNorm2d(planes)
        self.relu = nn.ReLU(inplace=True)
        # self.conv2 = conv3x3(inplanes, planes)
        #self.conv2 = conv_attn3x3(planes, planes)
